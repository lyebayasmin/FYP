...
export default function LessonTypeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Vocabulary — go to CategoryScreen first to pick a category */}
      <TouchableOpacity
        style={styles.card}
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push('/GrammarScreen')}
      >
        <Text style={styles.icon}>📐</Text>
        <Text style={styles.cardTitle}>Grammar</Text>
        <Text style={styles.cardDesc}>Learn grammar rules from basics</Text>
      </TouchableOpacity>
